...
echo ===================================================
echo.
echo Nombre de la tarea : Optimizador Alex Alcivar
...
"$Accion = New-ScheduledTaskAction -Execute 'C:\LimpiezaProgramada\Optimizador.bat';" ^
"$TriggerInicio = New-ScheduledTaskTrigger -AtLogOn;" ^
...
"Register-ScheduledTask -TaskName 'Optimizador Alex Alcivar' -Action $Accion -Trigger @($TriggerInicio,$TriggerHora) -Principal $Principal -Force"
...
echo ===================================================
echo.
echo Nombre de tarea : Optimizador Alex Alcivar
